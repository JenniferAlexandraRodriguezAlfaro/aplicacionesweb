...
const MI_API_KEY = '9Jul7TcgcZfNhLCtjtEF4c0PAGtLiXM5Fd0o2Uw4';
let queDia = 16;
let queMes = 6;
let queAno = 1995; //xD
let html = '';
...
function buscar()
{
    ...
    if (queDia <= 0 || queMes <= 0 || queAno<= 0) {
        alertify.alert('¡Atencion!', 'La fecha tiene un valor cere en uno de su(s) dato(s)');
    }else{
...
function pintarDatos()
{
    ...
    $('#h5Nnombre').html(datos.copyright);
